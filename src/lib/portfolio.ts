...
export const PORTFOLIO: Company[] = [
  ...
  { name: "Astro Mechanica", href: "https://www.astromecha.co/", sectors: ["Aerospace", "Energy", "Defense"], blurb: "Turboelectric adaptive engines, airframes, and flight systems for the next generation of flight.", logo: "/logos/astro-mechanica.png", cardLogo: "/logos/cards/astro-mechanica.png", image: "/work/cards/astro-mechanica.jpg", cardImage: "/work/cards/astro-mechanica.jpg" },
  { name: "Allia Health", href: "https://allia.health/", sectors: ["Healthcare", "AI", "Software"], blurb: "A modern EHR connecting intake, care, documentation, prescribing, and billing for behavioral health practices.", logo: "/logos/allia-health.png", cardLogo: "/logos/cards/allia-health.png", image: "/work/cards/allia-health.jpg", cardImage: "/work/cards/allia-health.jpg" },

...
export const FOUNDERS: Founder[] = [
  { name: "Akshay Narisetti", companyName: "Pocket", linkedin: "https://www.linkedin.com/in/akshaynarisetti" },
  { name: "Gabriel Dymowski", companyName: "Pocket", linkedin: "https://www.linkedin.com/in/gabrieldymowski" },
  { name: "Jack Qiu", companyName: "Ultrasonium" },
  { name: "Christopher Carter", companyName: "Ultrasonium" },
  { name: "Hunter Brown", companyName: "Ultrasonium" },
  { name: "Alexander Urbanski", companyName: "Ultrasonium" },
  { name: "Thomas Sohmers", companyName: "Positron", linkedin: "https://www.linkedin.com/in/trsohmers" },
  { name: "Akash Ramdas", companyName: "Matforge" },
  { name: "Advaith Sridhar", companyName: "Matforge" },
  { name: "Kareem Selim", companyName: "Raspire" },
  { name: "Hassan Mostafa", companyName: "Raspire" },
  { name: "Ariel Ekblaw", companyName: "Rendezvous Robotics", linkedin: "https://www.linkedin.com/in/arielekblaw" },
  { name: "Phil C. Frank", companyName: "Rendezvous Robotics" },
  { name: "Joe Landon", companyName: "Rendezvous Robotics", linkedin: "https://www.linkedin.com/in/joelandon" },
  { name: "Ivan Zakazov", companyName: "Compresr" },
  { name: "Oussama Gabouj", companyName: "Compresr" },
  { name: "Berke Argin", companyName: "Compresr" },
  { name: "Kamel Charaf", companyName: "Compresr" },
  ...
  { name: "Lucas Volini", companyName: "Allia Health" },

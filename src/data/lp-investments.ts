...
export const LP_INVESTMENTS: InvestmentRecord[] = [
  ...
  { id: "59-pocket", chronology: 59, company: "Pocket", investedCost: 25000, investmentDate: "2026-09-16", round: "Series A", entryValuation: "TBD (deal-room estimate up to $500M)", instrument: "Equity", platform: "AngelList", driveFolderId: "1YslMnAweDHAeMsxY00QspItA_1LAxd39", logo: "/logos/cards/pocket.png", description: "AI for real-world conversations, from capture through follow-through.", reviewStatus: "pending", reviewNote: "Owner-confirmed commitment; valuation is not final, the supplied offering documents are generic and unsigned, and cash-movement evidence remains pending.", securityAllocation: [{ securityType: "Equity", share: 1 }] },
];

...
export const LP_INVESTMENTS: InvestmentRecord[] = [
  ...
  { id: "12-apptronik", chronology: 12, company: "Apptronik", investedCost: 29222, investmentDate: "2026-05-13", round: "Series A", entryValuation: "~$4.9B post-money", instrument: "Secondary", platform: "AngelList", driveFolderId: "1xr2MFkdyzodS6PgKsiaWG3e3lrdu4Wy-", logo: "/logos/cards/apptronik.png", description: "General-purpose humanoid robots for industry.", reviewStatus: "verified", reviewNote: "AngelList reduced the original $30,000 allocation to $29,222 after the SPV was oversubscribed. The $778 excess was credited to the AngelList Investor Account; it was not returned to the bank." },
  ...
  { id: "46-autostep", chronology: 46, company: "Autostep", investedCost: 5000, investmentDate: "2026-09-02", round: "Seed", entryValuation: "$25M post-money cap", instrument: "SAFE", platform: "AngelList", driveFolderId: "1hFluYp4ma4dg2c9SO2sf7tCWU3O2hAlX", logo: "/logos/cards/autostep.png", description: "The measurement and ROI layer for human and agent work.", reviewStatus: "pending", reviewNote: "Owner-confirmed position; supplied legal package is mismatched and does not evidence Autostep execution.", securityAllocation: [{ securityType: "SAFE", share: 1 }] },
  { id: "47-blue-origin-series-a", chronology: 47, company: "Blue Origin", investedCost: 25000, investmentDate: "2026-09-06", round: "Series A", entryValuation: "$130B pre-money", instrument: "SPV", platform: "AngelList", driveFolderId: "1i9MBMOc653LDMENmHpLvTzStv1eaM1J1", logo: "/logos/cards/blue-origin.png", description: "A second Blue Origin position through a distinct layered SPV.", reviewStatus: "pending", reviewNote: "Owner-confirmed amount, date, and AngelList funding movement; investor-specific execution remains unevidenced.", securityAllocation: [{ securityType: "Not specified", share: 1 }] },
  { id: "48-molagri", chronology: 48, company: "Molagri", investedCost: 5000, investmentDate: "2026-09-07", round: "N/A", entryValuation: "N/A", instrument: "SPV", platform: "AngelList", driveFolderId: "1g-tuYJOwgQZ6mIg5mzgzpRKjJi_GBENy", logo: "/logos/cards/molagri.svg", description: "Precision biological crop protection.", reviewStatus: "pending", reviewNote: "Owner-confirmed amount, date, and AngelList funding movement; executed acceptance remains unevidenced.", securityAllocation: [{ securityType: "Not specified", share: 1 }] },
  { id: "49-trynearby", chronology: 49, company: "TryNearby", investedCost: 10000, investmentDate: "2026-09-07", round: "N/A", entryValuation: "N/A", instrument: "SPV", platform: "AngelList", driveFolderId: "1TtxI66VvKWw-MB1qpXTqNhGOdeCJG9dV", logo: "/logos/cards/trynearby.svg", description: "Local creators for local businesses.", reviewStatus: "pending", reviewNote: "Owner-confirmed amount, date, and AngelList funding movement; executed acceptance remains unevidenced.", securityAllocation: [{ securityType: "Not specified", share: 1 }] },
  { id: "50-familiar-labs", chronology: 50, company: "Familiar Labs", investedCost: 10000, investmentDate: "2026-09-07", round: "N/A", entryValuation: "N/A", instrument: "SPV", platform: "AngelList", driveFolderId: "1r6iaf0utunzr8KjTF9cb4qW-0HM-281e", logo: "/logos/cards/familiar-labs.svg", description: "AI dubbing that preserves the performance.", reviewStatus: "pending", reviewNote: "Owner-confirmed amount, date, and AngelList funding movement; executed acceptance remains unevidenced.", securityAllocation: [{ securityType: "Not specified", share: 1 }] },
  { id: "51-carsignal", chronology: 51, company: "CarSignal", investedCost: 5000, investmentDate: "2026-09-07", round: "N/A", entryValuation: "N/A", instrument: "SPV", platform: "AngelList", driveFolderId: "1S7uSIfCQZgsFIV4if9WKC4GQPUscvDbn", logo: "/logos/cards/carsignal.svg", description: "The AI operating system for independent auto shops.", reviewStatus: "pending", reviewNote: "Owner-confirmed amount, date, and AngelList funding movement; executed acceptance remains unevidenced.", securityAllocation: [{ securityType: "Not specified", share: 1 }] },
  { id: "52-datoric", chronology: 52, company: "Datoric", investedCost: 10000, investmentDate: "2026-09-07", round: "N/A", entryValuation: "N/A", instrument: "SPV", platform: "AngelList", driveFolderId: "1UhxNn2e916iNFyqAcsSAzdkzMhke-4Es", logo: "/logos/cards/datoric.svg", description: "Licensed multimodal data for frontier AI systems.", reviewStatus: "pending", reviewNote: "Owner-confirmed amount, date, and AngelList funding movement; executed acceptance remains unevidenced.", securityAllocation: [{ securityType: "Not specified", share: 1 }] },
  { id: "53-rasyn", chronology: 53, company: "Rasyn", investedCost: 10000, investmentDate: "2026-09-07", round: "N/A", entryValuation: "N/A", instrument: "SPV", platform: "AngelList", driveFolderId: "1T9DGWnbs1zjy7QU17iugBiFIA117i5Ue", logo: "/logos/cards/rasyn.svg", description: "AI models and experimentation for chemical discovery.", reviewStatus: "pending", reviewNote: "Owner-confirmed amount, date, and AngelList funding movement; executed acceptance remains unevidenced.", securityAllocation: [{ securityType: "Not specified", share: 1 }] },
  ...
  { id: "57-astro-mechanica", chronology: 57, company: "Astro Mechanica", investedCost: 25000, investmentDate: "2026-09-14", round: "Series B", entryValuation: "$500M pre-money", instrument: "Equity", platform: "AngelList", driveFolderId: "1U9X7aBMqYbNur4ZymkjfhX5o22S49wVb", logo: "/logos/cards/astro-mechanica.png", description: "Turboelectric propulsion and integrated aerospace systems.", reviewStatus: "pending", reviewNote: "Owner-confirmed position; supplied offering documents are generic and unsigned, and cash-movement evidence remains pending.", securityAllocation: [{ securityType: "Equity", share: 1 }] },
  { id: "58-atomarine", chronology: 58, company: "Atomarine", investedCost: 10000, investmentDate: "2026-09-16", round: "Seed", entryValuation: "$125M post-money cap", instrument: "SAFE", platform: "AngelList", driveFolderId: "1nZD5UYXSxlF2E3rn9jO1wDly8sG9zRI2", logo: "/logos/cards/atomarine.png", description: "Floating data center campuses with standalone power and seawater cooling.", reviewStatus: "pending", reviewNote: "Owner-confirmed position; supplied offering documents are generic and unsigned, and cash-movement evidence remains pending.", securityAllocation: [{ securityType: "SAFE", share: 1 }] },
  { id: "59-pocket", chronology: 59, company: "Pocket", investedCost: 15000, investmentDate: "2026-09-16", round: "Series A", entryValuation: "TBD (deal-room estimate up to $500M)", instrument: "Equity", platform: "AngelList", driveFolderId: "1YslMnAweDHAeMsxY00QspItA_1LAxd39", logo: "/logos/cards/pocket.png", description: "AI for real-world conversations, from capture through follow-through.", reviewStatus: "pending", reviewNote: "Owner revised the commitment from $25,000 to $15,000 on September 22, 2026; valuation is not final, the supplied offering documents are generic and unsigned, and cash-movement evidence remains pending.", securityAllocation: [{ securityType: "Equity", share: 1 }] },
];
...
export const LP_SNAPSHOT = {
  ...
  sourceModifiedAt: "2026-09-22",
  publishedAt: "2026-09-22",
  recordCount: 59,
  investedCostTotal: 845236.25,
